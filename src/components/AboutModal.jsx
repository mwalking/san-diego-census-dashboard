...
function AboutModal({ isOpen, onClose }) {
  const sections = Array.isArray(COPY.aboutModal.sections) ? COPY.aboutModal.sections : [];
  const fallbackBody = Array.isArray(COPY.aboutModal.body) ? COPY.aboutModal.body : [];
